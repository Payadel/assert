...
```sh
  git clone https://github.com/Payadel/assert
```
...
3. Run tests to ensure everything is Ok:
...
by [submitting an issue on GitHub](https://github.com/Payadel/assert/issues). Before you create an issue,
...
1. Search our repository for open or closed
   [Pull Requests](https://github.com/Payadel/assert/pulls)
