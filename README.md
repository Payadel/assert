...
The `success` output can be used by other actions or workflows to determine whether the assertions passed or failed. The `messagesStr` and `messages` outputs can be used for debugging and to provide more detailed information about the assertions that passed or failed.
